    ...
    NewCustomerMenu() {
        ...
        b.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                new CustomerDao().add(new Customer(tFirstname.getText(),tLastName.getText(),new Address(tStreet.getText(),tHouseNumber.getText(),tCity.getText(),tPostalCode.getText())));
