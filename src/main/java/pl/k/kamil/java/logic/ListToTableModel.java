...
public class ListToTableModel {
    ...
    public TableModel allRentTable(List<Rent> rents) {
        ...
        String[] column = {"ID", "Numer rejestracyjny", "Marka", "ID Klienta", "Imię", "Nazwisko", "Data wypożyczenia", "Data zwrotu", "Realna data zwrotu", "Cena", "dodatkowe koszty", "cena końcowa", "status"};
